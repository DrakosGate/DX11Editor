...
CLevel::Draw(ID3D11DeviceContext* _pDevice)
{
	...
	m_pDiffuseMRT->ClearRenderTarget(_pDevice, m_pDiffuseMRT->GetDepthStencilView(), m_pClearColour);
	m_pNormalsMRT->ClearRenderTarget(_pDevice, m_pDiffuseMRT->GetDepthStencilView(), m_pClearColour);
	m_pPositionMRT->ClearRenderTarget(_pDevice, m_pDiffuseMRT->GetDepthStencilView(), m_pClearColour);
	...
	m_pRenderTargets[RENDER_DEFERRED].SetRenderTarget(_pDevice, 1, 0);
