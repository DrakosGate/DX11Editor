...
struct TBoneInfo
{
	...
	D3DXMATRIX m_matBoneOffset;
	D3DXMATRIX m_matFinalTransformation;
};
...
public:
	...
	virtual void BoneTransform(float _fTimeInSeconds, std::vector<D3DXMATRIX>& _rMatVector);
	virtual void ReadNodeHierarchy(float _fAnimationTime, const aiNode* _pNode, const D3DXMATRIX& _rMatParent);
	...
	void ToDXMatrix(const aiMatrix4x4& _rAIMat, D3DXMATRIX& _rOutput);
