...
//}
//void
//AICLKernel::SendDataToGPU( OpenCLContext* _pOpenCL, AIHiveMind* _pHiveMind, float _fDeltaTime )
//{
//	cl_int iError = 0;
...
//}
//void
//AICLKernel::RetrieveOpenCLResults( OpenCLContext* _pOpenCL, AIHiveMind* _pHiveMind )
//{
