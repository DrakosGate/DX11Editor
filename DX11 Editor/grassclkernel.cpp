...
//}
//void 
//CGrassCLKernel::CreateBuffers(OpenCLContext* _pOpenCL, Grass* _pGrass, std::vector<RenderEntity*>* _pCollisionObjects)
//{
//	cl_int iError = 0;
...
//}
//void
//CGrassCLKernel::SendDataToGPU(OpenCLContext* _pOpenCL, Grass* _pGrass, std::vector<RenderEntity*>* _pCollisionObjects, float _fDeltaTime)
//{
...
//}
//void
//CGrassCLKernel::RetrieveOpenCLResults(OpenCLContext* _pOpenCL, Grass* _pGrass)
//{
