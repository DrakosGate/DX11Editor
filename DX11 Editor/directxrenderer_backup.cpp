...
*/
bool
CDirectXRenderer::Initialise( HWND _hWnd, TSetupStruct* _pSetupData, int _iWindowWidth, int _iWindowHeight )
{
	...
	m_pLevel = new CLevel();
	m_pLevel->Initialise( m_pDevice, m_pDeviceContext, this, m_pSetupData, _hWnd, _iWindowWidth, _iWindowHeight );
...
{
	m_pLevel->Process( m_pDevice, m_pDeviceContext, _pClock, _fDeltaTick );
